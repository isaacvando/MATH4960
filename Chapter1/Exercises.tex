...
\begin{document}
  ...
  \exercise{1.4.ii} Pick two groups $H, K$ and two functors $F, G : \text{B}H \rightrightarrows \text{B}K$. By exercise 1.3.i, $F$ and $G$ are simply group homomorphisms. Now pick a natural transformation $\alpha : F \Rightarrow G$. 
